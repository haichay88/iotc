...
+ (function() {
    ...
    b = function() {
        ...
        return e.prototype.defaults = {
            ...
            var c, d, e;
            return d = a.getAttribute("data-animation-duration"), c = a.getAttribute("data-animation-delay"), e = a.getAttribute("data-animation-iteration"), this.animate(function(f) {
                return function() {
            ...
            var a, b, c, d, e;
            for (d = this.boxes, e = [], b = 0, c = d.length; c > b; b++) a = d[b], e.push(a.style.visibility = "visible", a.className = a.className + " animated");
            return e
            ...
            var b, c, d, e, f;
            return c = a.getAttribute("data-animation-offset") || this.config.offset, f = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset, e = f + Math.min(this.element.clientHeight, this.util().innerHeight()) - c, d = this.offsetTop(a), b = d + a.clientHeight, e >= d && b >= f
...
+ (function(r, x, m) {
    r.ichecked || (r.ichecked = function() {
        ...
        var l = r.navigator.userAgent,
            ca = /MSIE [5-8]/.test(l) || 9 > x.documentMode,
            D = /Opera Mini/.test(l),
            E = A.classes.base,
            O = A.classes.div.replace("#", E),
            da = A.classes.area.replace("#", E),
            P = A.classes.input.replace("#", E),
            Q = A.classes.label.replace("#", E);
        delete A.classes;
        var ea = {},
            p = {},
            la = new RegExp(E + "\\[(.*?)\\]"),
            ...
            fa = r.getComputedStyle,
            X = r.PointerEvent || r.MSPointerEvent,
            y = "ontouchend" in r,
            F = /mobile|tablet|phone|ip(ad|od)|android|silk|webos/i.test(l),
            l = ["mouse", "down", "up", "over", "out"],
            u = r.PointerEvent ? ["pointer", l[1], l[2], l[3], l[4]] : ["MSPointer", "Down",
                "Up", "Over", "Out"
            ],
            R = ["touch", "start", "end"],
            S = y && F || X,
            T = S ? y ? R[0] + R[1] : u[0] + u[3] : l[0] + l[3],
            Y = S ? y ? R[0] + R[2] : u[0] + u[4] : l[0] + l[4],
            M = S ? y ? !1 : u[0] + u[1] : l[0] + l[1],
            Z = S ? y ? !1 : u[0] + u[2] : l[0] + l[2],
            l = D ? "" : T + ".i " + Y + ".i ",
            u = !D && M ? M + ".i " + Z + ".i" : "",
            J, U, ga = !1 !== A.areaStyle ? 'position:absolute;display:block;content:"";top:#;bottom:#;left:#;right:#;' : 0,
            V = function(a, c, e) {
        ...
        var G = function(a, c, e, b, f, d, k) {
            ...
            ia = function(a, c, e, b, f) {
                e = [];
                for (b = a.length; b--;)
                    if (c = a[b], c.type) ~"input[type=checkbox],input[type=radio]".indexOf(c.type) && e.push(c);
                    else
                        for (c = m(c).find("input[type=checkbox],input[type=radio]"),
                            f = c.length; f--;) e.push(c[f]);
                return e
            },
            K = function(a, c, e, b) {
                for (; a && 9 !== a.nodeType;)
                    if ((a = a.parentNode) && a.tagName == c.toUpperCase() && ~a.className.indexOf(e)) {
                        b = a;
                        break
                    }
                return b
            ...
            ja = function(a, c, e, b) {
                ...
                for (var f = a.length; f--;) {
                    var d = a[f],
                        ...
                        w = d.className,
                        z, D = d.type,
                        aa = m.cache ? m.cache[d[m.expando]] :
                        0,
                        B = I(w),
                        L, v, C = "",
                        H = !1;
                    ...
                    if (!1 !== k.init &&
                        ~g.indexOf(D)) {
                        for (B && ha(d, B); !p[B];)
                            if (B = Math.random().toString(36).substr(2, 5), !p[B]) {
                                L = E + "[" + B + "]";
                                break
                            }
                        delete k.autoInit;
                        ...
                        if (q)
                            for (h = m('label[for="' + q + '"]'); h.length--;) q = h[h.length], q !== g && v.push(q);
            ...
            ka = function(a, c, e, b, f, d, k, l, g, h, n) {
                var r = a.type,
                    u = "radio" == r ? "Radio" : "Checkbox",
                    t, q, w, z, y, x, B, A, v, C;
                c || (c = K(a, "div", d.className));
                if (c) {
                    for (t in b)
                        if (q = b[t], e[t][0] !== q && "updated" !== k && "click" !== k && (a[t] = q), h && (q ? a.setAttribute(t, t) : a.removeAttribute(t)), d[t] !== q) {
                            d[t] = q;
                            v = !0;
                            if ("checked" == t && (C = !0, !n && q && (p[f].done || h) && "radio" == r && a.name))
                                for (z = K(a, "form", ""), w = 'input[name="' + a.name + '"]', w = z && !h ? m(z).find(w) : m(w), z = w.length; z--;) y = w[z], x = I(y.className), a !== y && p[x] && p[x].checked && (B = {
                                    checked: [!0, "Checked", "Unchecked"]
                                }, A = {
                                    checked: !1
                                }, ka(y, !1, B, A, x, p[x], "updated", l, g, h, !0));
                            w = [d[t + "Class"], d[t + u + "Class"], d[e[t][1] + "Class"], d[e[t][1] + u + "Class"], d[t + "LabelClass"]];
                            z = [w[3] || w[2], w[1] || w[0]];
                            q && z.reverse();
                            G(c, z);
                            if (d.mirror && w[4])
                                for (z = m("label." + d.esc); z.length--;) G(z[z.length],
                                    w[4], q ? 1 : 0);
                            l && !n || N(a, f, e[t][q ? 1 : 2])
                        }
        ...
        m.fn.icheck = function(a, c) {
            if (/^(checked|unchecked|indeterminate|determinate|disabled|enabled|updated|toggle|destroy|data|styler)$/.test(a))
                for (var e = ia(this), b = e.length; b--;) {
                    var f = e[b],
                        d = I(f.className);
                    if (d) {
        ...
        m(x).on("click.i " + l + u, "label." + Q + ",div." + O, function(a) {
            ...
            if (e) {
                var b = a.type,
                    ...
                    e = "DIV" == c.tagName,
                    k, l, g, h, n = [
                        ["label", f.activeLabelClass, f.hoverLabelClass],
                        ["div", f.activeClass, f.hoverClass]
                    ];
                e && n.reverse();
                if (b == M || b == Z) {
                    n[0][1] && G(c, n[0][1], b == M ? 1 : 0);
                    if (f.mirror && n[1][1])
                        for (g = m(n[1][0] + "." + d); g.length--;) G(g[g.length],
                            n[1][1], b == M ? 1 : 0);
                    e && b == Z && f.tap && F && X && !D && (h = !0)
                } else if (b == T || b == Y) {
                    n[0][2] && G(c, n[0][2], b == T ? 1 : 0);
                    if (f.mirror && n[1][2])
                        for (g = m(n[1][0] + "." + d); g.length--;) G(g[g.length], n[1][2], b == T ? 1 : 0);
            ...
            if (c) {
                var e = a.type,
                    b = p[c],
                    f = b.esc,
                    d = "click" == e ? !1 : K(this, "div", b.className);
                if ("click" == e) p[c].change = +new Date, a.stopPropagation();
                else if ("change" == e) d && !this.disabled && W(this, d, c, "click");
                else if (~e.indexOf("focus")) {
                    if (a = [b.focusClass, b.focusLabelClass], a[0] && d && G(d, a[0], "focusin" == e ? 1 : 0), b.mirror && a[1])
                        for (b = m("label." + f); b.length--;) G(b[b.length], a[1], "focusin" == e ? 1 : 0)
                } else d && !this.disabled && ("keyup" == e ? (("checkbox" == this.type && 32 == a.keyCode && b.keydown || "radio" == this.type &&
